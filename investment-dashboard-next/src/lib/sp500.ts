// Auto-generated from datahub constituents.csv
// Last updated: 2026-05-29
export interface SP500Entry { ticker: string; name: string; sector: string; }

export const SP500: SP500Entry[] = [
  ...
  { ticker: "CPB", name: "Campbell's Company (The)", sector: "Consumer Staples" },
